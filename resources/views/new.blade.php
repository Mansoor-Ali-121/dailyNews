...
<form method="POST" action="{{ route('city.add') }}" class="needs-validation" novalidate>
    ...
    <div class="row g-4">
        ...
        <div class="col-12">
            <div class="form-floating position-relative">
                <i class="fas fa-country floating-icon"></i>
                <input type="text"
                ...
                <label for="country_name" class="form-label text-muted ms-4">City Name</label>
                @error('country_name')
                    <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-12">
            <div class="form-floating position-relative">
                ...
                <input type="text"
                    ...
                    placeholder="City Name">
                <label for="country_code" class="form-label text-muted ms-4">City Name</label>
                @error('country_code')
                    <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="col-md-6">
            <div class="form-floating position-relative">
                ...
                <label for="country_slug" class="form-label text-muted ms-4">System Generated Slug</label>
                @error('country_slug')
                    <div class="invalid-feedback d-block">{{ $message }}</div>
                @enderror
            </div>
