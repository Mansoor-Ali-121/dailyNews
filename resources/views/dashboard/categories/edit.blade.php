...
@section('main_section')
                ...
                <div class="card border-0 shadow-lg overflow-hidden">
                    ...
                    <div class="card-body p-5">
                        ...
                        <form action="{{ route('category.update', $category->id) }}" method="post">
                            ...
                            <div class="col-md-6 mb-3"> {{-- Added mb-3 for spacing --}}
                                ...
                                <div class="col-12">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Category Name" onkeyup="generateSlug()">
                                ...
                                <div class="col-12">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="text" class="form-control border-2 ps-5 py-3 bg-light"
                                            id="actual_slug" name="actual_slug"
                                            value="{{ old('actual_slug', $category->category_slug) }}" {{-- Pre-fill with existing slug --}}
                                    ...
                                    <p class="form-note text-muted mt-2 ps-1">You can provide a custom slug, or leave it blank
                                ...
                                <div class="col-12">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="text" class="form-control border-2 ps-5 py-3 bg-light"
                                            ...
                                            value="{{ old('category_slug', $category->category_slug) }}" readonly
                                    ...
                                    <div class="form-floating position-relative">
                                        ...
                                        <select name="category_status" id="category_status"
                                            ...
                                            <option value="" disabled
                                                {{ old('category_status', $category->category_status) == '' ? 'selected' : '' }}>
                                                Select Status</option>
                                            <option value="active"
                                                {{ old('category_status', $category->category_status) == 'active' ? 'selected' : '' }}>
                                                Active</option>
                                            <option value="inactive"
                                                {{ old('category_status', $category->category_status) == 'inactive' ? 'selected' : '' }}>
                                                Inactive</option>
                                        </select>
    ...
    <script>
        function generateSlug() {
            ...
            const actualSlugInput = document.getElementById('actual_slug');
            const categorySlugOutput = document.getElementById('category_slug');

            if (!categoryNameInput || !actualSlugInput || !categorySlugOutput) {
                console.error('One or more slug-related elements not found.');
                return;
            }

            let inputForSlug = '';

            // If the "Custom Slug" field has a value, use it.
            if (actualSlugInput.value.trim() !== '') {
                inputForSlug = actualSlugInput.value.trim();
            } else {
                // Otherwise, use the "Category Name" field.
                inputForSlug = categoryNameInput.value.trim();
            }

            // If both are empty, clear the generated slug and return.
            if (inputForSlug === '') {
                categorySlugOutput.value = '';
                return;
            }

            // Slugify the input
            const generatedSlug = inputForSlug
                .toLowerCase()
                .replace(/[^a-z0-9\u0600-\u06FF\s-]/g, '') // Allow Urdu characters (\u0600-\u06FF)
                .replace(/\s+/g, '-')
                .replace(/--+/g, '-')
                .replace(/^-+|-+$/g, '');

            categorySlugOutput.value = generatedSlug;
        }

        // Call generateSlug on page load to ensure the generated slug is correct
        window.addEventListener('load', function() {
            generateSlug();

            // Add event listener to category_name to re-generate slug if actual_slug is empty
            ...
            // Add event listener to actual_slug to trigger slug generation
            document.getElementById('actual_slug').addEventListener('input', generateSlug);
        });
    </script>
@endsection