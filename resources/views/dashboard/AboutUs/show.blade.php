                    ...
                    <div class="card-header position-relative" style="background: var(--primary-gradient);">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="d-flex gap-3 mt-3 mt-md-0">
                                <a href="{{ route('about.add') }}"
                                    class="btn btn-light btn-lg rounded-pill px-4 py-2 shadow-sm" id="addVideoBtn"
                                    aria-label="Add New Video">
                                    <i class="fas fa-plus-circle me-2" aria-hidden="true"></i> Add New About Us
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        @if ($about->isEmpty())
                            <div class="empty-state">
                                ...
                                <h4 class="h3 text-muted mb-4">No About Found</h4>
                                <p class="text-muted fs-5 mb-5">Get started by adding your first About Us to the system</p>
                                <a href="{{ route('terms.add') }}"
                                    class="btn btn-primary btn-lg px-5 rounded-pill shadow-sm"
                                    aria-label="Create First Video">
                                    <i class="fas fa-plus-circle me-2"></i> Create First About Us
                                </a>
                            </div>
                        @else
                                            ...
                                            <tr class="border-top">
                                                ...
                                                <td class="pe-4 text-end">
                                                    <div class="d-flex justify-content-end gap-2 action-buttons">
                                                        ...
                                                        <a href="{{ route('about.view', $item->id) }}"
                                ...
                                <div class="pagination-container">
                                    <nav aria-label="Videos pagination">
                                        <ul class="pagination">
                                            ...
                                            @else
                                                <li class="page-item">
                                                    <a class="page-link" href="{{ $about->previousPageUrl() }}"
                                                        rel="prev">
                                                        <i class="fas fa-chevron-left"></i>
                                                        <span class="d-none d-sm-inline ms-2">Prev</span>
                                                    </a>
                                            ...
                                            {{-- Pagination Elements --}}
                                            @foreach ($about->getUrlRange(1, $about->lastPage()) as $page => $url)
                                                @if ($page == $about->currentPage())
                                            ...
                                            {{-- Next Page Link --}}
                                            @if ($about->hasMorePages())
                                                <li class="page-item">
                                                    <a class="page-link" href="{{ $about->nextPageUrl() }}"
                                                        rel="next">
