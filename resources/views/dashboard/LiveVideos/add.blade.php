                ...
                <div class="card border-0 shadow-lg overflow-hidden">
                    ...
                    <div class="card-header p-5 position-relative overflow-hidden">
                        ...
                        <div class="d-flex justify-content-between align-items-center position-relative" style="z-index: 2;">
                            <div>
                                <h2 class="h3 mb-2 text-white"><i class="fas fa-video me-3"></i> Add Live Video</h2>
                                <p class="mb-0 text-white-50 fs-5">Create a new live video entry</p>
                            </div>
                            {{-- Current User  --}}
                            @if (Auth::check())
                            ...
                            @endif
                            <a href="{{ route('livevideo.show') }}" class="btn btn-light btn-lg rounded-pill px-4 py-2 shadow-sm hover-scale">
                    ...
                    <div class="card-body p-5">
                        ...
                        <form method="POST" action="{{ route('livevideo.add') }}" class="needs-validation">
                            @csrf
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-12">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="text"
                                            class="form-control border-2 ps-5 py-3 @error('video_id') is-invalid @enderror"
                                            id="video_url" name="video_url" value="{{ old('video_url') }}" required
                                            placeholder="YouTube Video ID">
                                        <label for="video_url" class="form-label text-muted ms-4">YouTube Video URL</label>
                                        @error('video_url')
                                ...
                                <div class="col-12">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="text"
                                            ...
                                            id="video_title" name="video_title" value="{{ old('video_title') }}" required
                                ...
                                <div class="col-12">
                                    <div class="form-floating position-relative">
                                        ...
                                        <select id="video_status"
                                            ...
                                            <option value="active"
                                                {{ old('video_status', 'active') == 'active' ? 'selected' : '' }}>
                                                Active
                                            </option>
                                            <option value="inactive"
                                                {{ old('video_status') == 'inactive' ? 'selected' : '' }}>
                                                Inactive
                                            </option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="text" name="slug" id="slug"
                                            ...
                                            value="{{ old('slug') }}" onkeyup="generateSlug()" placeholder="Custom Slug">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="text" class="form-control border-2 ps-5 py-3 bg-light"
                                            id="video_slug" name="video_slug" value="{{ old('video_slug') }}"
...
{{-- slug --}}
    <script>
        function generateSlug() {
            ...
            document.getElementById('video_slug').value = packageSlug;
        }
    </script>
