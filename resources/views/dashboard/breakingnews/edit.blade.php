...
@section('main_section')
                                ...
                                <div class="col-12">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="text" class="form-control border-2 ps-5 py-3" id="title"
                                            ...
                                            value="{{ old('title', $breakingNews->title) }}">
                                ...
                                <div class="col-12">
                                    <div class="form-floating position-relative">
                                        ...
                                        <textarea class="form-control border-2 ps-5 py-3" id="description" name="description" style="height: 150px" required
                                            placeholder="Breaking News Description">{{ old('description', $breakingNews->description) }}</textarea>
                                ...
                                <div class="col-12">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="file" class="form-control border-2 ps-5 py-3" id="image"
                                            name="image" accept="image/*"> {{-- Image is optional on edit typically --}}
                                        <div class="form-text ms-4">Recommended size: 1200x630 pixels (Max 2MB). Leave empty
                                            to keep current image.</div>
                                    </div>
                                    @error('image')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="text" class="form-control border-2 ps-5 py-3 bg-light"
                                            ...
                                            value="{{ old('slug', $breakingNews->breakingnews_slug) }}">
                                        {{-- Use breakingnews_slug here too --}}
                                        <label for="slug" class="form-label text-muted ms-4">Custom Slug</label>
                                    </div>
                                    @error('slug')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="text" class="form-control border-2 ps-5 py-3 bg-light"
                                            ...
                                            value="{{ old('breakingnews_slug', $breakingNews->breakingnews_slug) }}">
                                ...
                                <div class="col-12">
                                    <div class="form-floating position-relative">
                                        ...
                                        <select name="breakingnews_status" id="breakingnews_status"
                                            ...
                                            <option value="active"
                                                {{ old('breakingnews_status', $breakingNews->breakingnews_status) == 'active' ? 'selected' : '' }}>
                                                Active</option>
                                            <option value="inactive"
                                                {{ old('breakingnews_status', $breakingNews->breakingnews_status) == 'inactive' ? 'selected' : '' }}>
                                                Inactive</option>
                                        </select>
                                ...
                                <div class="col-12 mt-4">
                                    <div class="d-flex justify-content-end gap-3">
                                        ...
                                        <button type="submit"
                                            ...
                                            <i class="fas fa-save me-2"></i> Update Breaking News
                                        </button>
                                    </div>
                                </div>
                            </div>
    ...
    {{-- Form Styling (copied directly from your add form, adjust if needed) --}}
    <style>
        /* Base Card Styles */
        .card {
            border-radius: 20px;
    ...
    <script>
        ...
        // Initialize the generated slug field on page load if a title is present
        document.addEventListener('DOMContentLoaded', function() {
            const titleInput = document.getElementById('title');
            if (titleInput && titleInput.value) {
                // If you want the system generated slug to always match the title on load
                // document.getElementById('slug').value = titleInput.value;
                generateSlug();
            }
        });
    </script>
