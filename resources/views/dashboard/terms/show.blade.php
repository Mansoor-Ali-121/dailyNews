                        ...
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="d-flex gap-3 mt-3 mt-md-0">
                                <a href="{{ route('terms.add') }}"
                                    ...
                                    <i class="fas fa-plus-circle me-2" aria-hidden="true"></i> Add New Term and Condition
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        @if ($terms->isEmpty())
                            <div class="empty-state">
                                ...
                                <h4 class="h3 text-muted mb-4">No Term Found</h4>
                                ...
                                <a href="{{ route('terms.add') }}"
                                    ...
                                    <i class="fas fa-plus-circle me-2"></i> Create First Term and Condition
                                </a>
                            </div>
                        @else
                                ...
                                <table id="videosTable" class="table align-middle mb-0 display">
                                    ...
                                    <tbody>
                                        @foreach ($terms as $term)
                                            <tr class="border-top">
                                                <td class="ps-4 fw-bold text-muted fs-5">{{ $term->id }}</td>
                                                ...
                                                <td class="pe-4 text-end">
                                                    <div class="d-flex justify-content-end gap-2 action-buttons">
                                                        <a href="{{ route('terms.edit', $term->id) }}"
                                                            ...
                                                            aria-label="Edit Video {{ $term->title }}">
                                                            <i class="fas fa-edit me-1" aria-hidden="true"></i> Edit
                                                        </a>
                                                        {{-- Corrected View Button --}}
                                                        <a href="{{ route('terms.view', $term->id) }}"
...
>
                                                        ...
                                                        <form action="{{ route('terms.delete', $term->id) }}"
                                ...
                                <div class="pagination-container">
                                    <nav aria-label="Videos pagination">
                                        <ul class="pagination">
                                            ...
                                            @else
                                                <li class="page-item">
                                                    <a class="page-link" href="{{ $terms->previousPageUrl() }}"
                                                        rel="prev">
                                                        <i class="fas fa-chevron-left"></i>
                                                        <span class="d-none d-sm-inline ms-2">Prev</span>
                                                    </a>
                                            ...
                                            {{-- Pagination Elements --}}
                                            @foreach ($terms->getUrlRange(1, $terms->lastPage()) as $page => $url)
                                            ...
                                            @if ($terms->hasMorePages())
                                                <li class="page-item">
                                                    <a class="page-link" href="{{ $terms->nextPageUrl() }}"
                                                        rel="next">
