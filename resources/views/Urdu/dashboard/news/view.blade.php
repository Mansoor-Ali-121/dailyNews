        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h1><i class="fas fa-newspaper me-2"></i>News Details</h1>
                    <p class="lead">Complete information about the news article</p>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="row">
            <div class="col-12">
                <div class="detail-container">
                    <table class="detail-table">
                        <tbody>
                                ...
                                <td>
                                    @if ($item->news_image)
                                        <div class="news-image-container">
                                            <img src="{{ asset('news/news_images/' . $item->news_image) }}"
                                               alt="{{ $item->news_title ?? 'News Image' }}"
                                                class="news-image">
                                        </div>
                                        <div class="text-muted mt-2">
                                            <i class="fas fa-info-circle me-2"></i>File: {{ $item->news_image }}
                                        </div>
                                    @else
                                        <div class="text-muted mt-2">
                            ...
                            {{-- @empty
                                <tr>
                                    <td colspan="2" class="text-center py-4">No news articles found.</td>
                                </tr>
                                @endforelse --}}
                        </tbody>
                    </table>
                ...
                <div class="content-section">
                 ...
                 <p class="content-section-image"> {!! $item->news_content !!}
             </p> 
