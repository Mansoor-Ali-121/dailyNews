                ...
                <div class="card border-0 shadow-lg overflow-hidden">
                    ...
                    <div class="card-header p-5 position-relative overflow-hidden">
                        ...
                        <div class="d-flex justify-content-between align-items-center position-relative" style="z-index: 2;">
                            <div>
                                <h2 class="h3 mb-2 text-white"><i class="fas fa-plus-circle me-3"></i> Add New Country</h2>
                                <p class="mb-0 text-white-50 fs-5">Create a new Country for your blog</p>
                            </div>
                    ...
                    <div class="card-body p-5">
                        ...
                        <form method="POST" action="{{ route('country.add') }}" class="needs-validation" novalidate>
                            @csrf
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    <div class="form-floating position-relative">
                                        <i class="fas fa-flag floating-icon"></i> {{-- Corrected icon for Country Name --}}
                                        <input type="text"
                                ...
                                <div class="col-12">
                                    <div class="form-floating position-relative">
                                        <i class="fas fa-globe floating-icon"></i> {{-- Corrected icon for Country Code --}}
                                        <input type="text"
                                            class="form-control border-2 ps-5 py-3 @error('country_code') is-invalid @enderror"
                                            id="country_code" name="country_code" value="{{ old('country_code') }}" required
                                ...
                                {{-- Custom Slug (Optional) Field with Floating Icon --}}
                                <div class="col-12"> {{-- Adjust col-12 to col-md-6 if this field is part of a two-column row --}}
                                    <div class="form-floating position-relative">
                                        <i class="fas fa-link floating-icon "></i> {{-- Icon correctly placed inside form-floating --}}
                                        <input type="text" name="actual_slug" id="actual_slug"
                                            ...
                                            value="{{ old('actual_slug') }}" onkeyup="generateSlug()"
                                            placeholder="Custom Slug">
                                        <label for="actual_slug" class="form-label text-muted ms-4">Custom Slug
                                            (Optional)</label>
                                        {{-- <div class="form-text text-muted ms-5">Lowercase, alphanumeric, and hyphens only (e.g., `united-states`).</div> --}}
                                        @error('actual_slug')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                                </div>
                                {{-- Generated Slug Field with Floating Icon --}}
                                <div class="col-12"> {{-- Use col-12 if it's a full-width field, or col-md-6 if it's part of a two-column row --}}
                                    <div class="form-floating position-relative">
                                        <i class="fas fa-hashtag floating-icon"></i> {{-- Correctly placed icon for Generated Slug --}}
                                        <input type="text" class="form-control border-2 ps-5 py-3 bg-light"
                                            id="country_slug" name="country_slug" value="{{ old('country_slug') }}"
