                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="text" name="name" id="name"
                                            class="form-control border-2 ps-5 py-3" value="{{ old('name') }}" required
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="email" name="email" id="email"
                                            class="form-control border-2 ps-5 py-3" value="{{ old('email') }}" required
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="password" name="password" id="password"
                                            class="form-control border-2 ps-5 py-3" required placeholder="Password">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="text" name="user_description" id="user_description"
                                            class="form-control border-2 ps-5 py-3" value="{{ old('user_description') }}"
                                            required placeholder="User Description">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="file-upload-wrapper">
                                            <input type="file" name="user_image" id="user_image"
                                                class="form-control border-2 py-3 file-upload-input"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating position-relative">
                                        ...
                                        <select name="user_type" id="user_type" class="form-select border-2 ps-5 py-3"
                                            required>
                                            <option value="" {{ old('user_type') == '' ? 'selected' : '' }}
                                                disabled>Select User type</option>
                                            <option value="admin" {{ old('user_type') == 'admin' ? 'selected' : '' }}>
                                                Admin</option>
                                            <option value="editor" {{ old('user_type') == 'editor' ? 'selected' : '' }}>
                                                Editor</option>
                                            <option value="author" {{ old('user_type') == 'author' ? 'selected' : '' }}>
                                                Author</option>
                                            <option value="reviewer"
                                                {{ old('user_type') == 'reviewer' ? 'selected' : '' }}>Reviewer</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating position-relative">
                                        ...
                                        <input type="text" name="user_slug" id="user_slug"
                                            ...
                                            value="{{ old('user_slug') }}" readonly placeholder="System Generated Slug">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating position-relative">
                                        ...
                                        <select name="user_status" id="user_status" class="form-select border-2 ps-5 py-3"
                                            required>
                                            <option value="active" {{ old('user_status') == 'active' ? 'selected' : '' }}>
                                                Active</option>
                                            <option value="inactive"
                                                {{ old('user_status') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                ...
                                <div class="col-12 mt-4">
                                    <div class="d-flex justify-content-end gap-3">
                                        <a href="{{ url()->previous() }}"
                                            class="btn btn-lg btn-outline-secondary rounded-pill px-4 shadow-sm hover-scale">
