    ...
    <div id="uc-menu-panel" data-uc-offcanvas="overlay: true;">
        <div class="uc-offcanvas-bar bg-white text-dark dark:bg-gray-900 dark:text-white">
            <header class="uc-offcanvas-header hstack justify-between items-center pb-4 bg-white dark:bg-gray-900">
                <div class="uc-logo">
                    {{-- Assuming the logo links to your application's homepage --}}
                    <a href="{{ url('/') }}" class="h5 text-none text-gray-900 dark:text-white">
                ...
                <ul class="nav-y gap-narrow fw-bold fs-5" data-uc-nav>
                    <li class="uc-parent">
                        ...
                        <ul class="uc-nav-sub" data-uc-nav="">
                            {{-- Assuming these are static HTML demo pages --}}
                            <li><a href="{{ asset('main/index.html') }}">Main</a></li>
                            <li><a href="{{ asset('demo-two/index.html') }}">Classic News</a></li>
                            <li><a href="{{ asset('demo-three/index.html') }}">Tech</a></li>
                            <li><a href="{{ asset('demo-four/index.html') }}">Classic Blog</a></li>
                            <li><a href="{{ asset('demo-five/index.html') }}">Gaming</a></li>
                            <li><a href="{{ asset('demo-six/index.html') }}">Sports</a></li>
                            <li><a href="{{ asset('demo-seven/index.html') }}">Newspaper</a></li>
                            <li><a href="{{ asset('demo-eight/index.html') }}">Magazine</a></li>
                            <li><a href="{{ asset('demo-nine/index.html') }}">Travel</a></li>
                            <li><a href="{{ asset('demo-ten/index.html') }}">Food</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="uc-parent">
                        ...
                        <ul class="uc-nav-sub" data-uc-nav="">
                            <li class="uc-parent">
                                ...
                                <ul class="uc-nav-sub">
                                    <li><a href="{{ asset('blog.html') }}">Full Width</a></li>
                                    <li><a href="{{ asset('blog-2cols.html') }}">Grid 2 Cols</a></li>
                                    <li><a href="{{ asset('blog-3cols.html') }}">Grid 3 Cols</a></li>
                                    <li><a href="{{ asset('blog-4cols.html') }}">Grid 4 Cols</a></li>
                                </ul>
                            </li>
                            <li class="uc-parent">
                                <a href="{{ asset('blog-details.html') }}">Blog - detail</a>
                                <ul class="uc-nav-sub">
                                    <li><a href="{{ asset('blog-details.html') }}">Blog detail</a></li>
                                    <li><a href="{{ asset('blog-details-2.html') }}">Blog detail - v2</a></li>
                                </ul>
                            </li>
                            <li class="uc-parent">
                                ...
                                <ul class="uc-nav-sub">
                                    ...
                                    <li><a href="{{ asset('reset-password.html') }}">Reset password</a></li>
                            ...
                            <li class="uc-parent">
                                ...
                                <ul class="uc-nav-sub">
                                    ...
                                    <li><a href="{{ asset('page-terms.html') }}">Terms of use</a></li>
                                    <li><a href="{{ asset('page-privacy.html') }}">Privacy policy</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li class="uc-parent">
                        ...
                        <ul class="uc-nav-sub" data-uc-nav="">
                            <li class="uc-parent">
                                <a href="{{ asset('shop.html') }}">Shop layouts</a>
                                <ul class="uc-nav-sub">
                                    <li><a href="{{ asset('shop.html') }}">Shop 4 cols</a></li>
                                    <li><a href="{{ asset('shop-3.html') }}">Shop 3 cols</a></li>
                                    <li><a href="{{ asset('shop-2.html') }}">Shop 2 cols</a></li>
                                    <li><a href="{{ asset('shop-sidebar.html') }}">Shop with sidebar</a></li>
                                </ul>
                            </li>
                            <li><a href="{{ asset('shop-category.html') }}">Archive category</a></li>
                            <li><a href="{{ asset('shop-product-detail.html') }}">Product detail</a></li>
                            <li><a href="{{ asset('shop-product-detail-2.html') }}">Product detail - v2</a></li>
                            <li><a href="{{ asset('shop-cart.html') }}">Cart</a></li>
                            <li><a href="{{ asset('shop-cart-2.html') }}">Cart - v2</a></li>
                            <li><a href="{{ asset('shop-checkout.html') }}">Checkout</a></li>
                            <li><a href="{{ asset('shop-checkout-2.html') }}">Checkout - v2</a></li>
                            <li><a href="{{ asset('shop-order.html') }}">Order confirmation</a></li>
                        </ul>
                    </li>
                    <li class="hr opacity-10 my-1"></li>
                    <li><a href="{{ asset('sign-in.html') }}">Sign in</a></li>
                    <li><a href="{{ asset('sign-up.html') }}">Create an account</a></li>
                </ul>
                                ...
                                <div class="hstack gap-2">
                                    <figure
                                        ...
                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque uc-transition-scale-up uc-transition-opaque"
                                            ...
                                            data-src="{{ asset('website/assets/images/common/products/img-07.jpg') }}"
                                            alt="Laptop Cover" data-uc-img="loading: lazy">
                                        <a href="{{ asset('shop-product-detail.html') }}" class="position-cover"
                                    ...
                                    <div class="content vstack gap-narrow fs-6">
                                        <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white"
                                                href="{{ asset('shop-product-detail.html') }}">Laptop Cover</a></h5>
                            ...
                            <article class="product type-product panel">
                                <div class="hstack gap-2">
                                    <figure
                                        ...
                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque uc-transition-scale-up uc-transition-opaque"
                                            src="{{ asset('website/assets/images/common/img-fallback.png') }}"
                                            data-src="{{ asset('website/assets/images/common/products/img-08.jpg') }}"
                                    ...
                                    <div class="content vstack gap-narrow fs-6">
                                        <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white"
                                                href="{{ asset('shop-product-detail.html') }}">Disney Toys</a></h5>
                                        <div class="hstack gap-narrow fs-7 opacity-50 text-dark dark:text-white"><span
                            ...
                            <article class="product type-product panel">
                                <div class="hstack gap-2">
                                    <figure
                                        ...
                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque uc-transition-scale-up uc-transition-opaque"
                                            src="{{ asset('website/assets/images/common/img-fallback.png') }}"
                                            data-src="{{ asset('website/assets/images/common/products/img-09.jpg') }}"
                                    ...
                                    <div class="content vstack gap-narrow fs-6">
                                        <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white"
                                                href="{{ asset('shop-product-detail.html') }}">Screen Axe</a></h5>
                                        <div class="hstack gap-narrow fs-7 opacity-50 text-dark dark:text-white"><span
                            ...
                            <article class="product type-product panel">
                                <div class="hstack gap-2">
                                    <figure
                                        ...
                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque uc-transition-scale-up uc-transition-opaque"
                                            src="{{ asset('website/assets/images/common/img-fallback.png') }}"
                                            data-src="{{ asset('website/assets/images/common/products/img-10.jpg') }}"
                                    ...
                                    <div class="content vstack gap-narrow fs-6">
                                        <h5 class="h6 m-0"><a class="text-none text-dark dark:text-white"
                                                href="{{ asset('shop-product-detail.html') }}">Airpods Pro</a></h5>
                                        <div class="hstack gap-narrow fs-7 opacity-50 text-dark dark:text-white"><span
                ...
                <div class="d-none md:d-flex">
                    <div class="position-relative w-100 ratio-1x1">
                        <img class="media-cover"
                            src="{{ asset('website/assets/images/demo-seven/common/newsletter.jpg') }}"
                                ...
                                <div class="swiper-slide text-white">
                                    <div class="type-post post panel">
                                        <a href="blog-details.html"
                                            class="fs-7 fw-normal text-none text-inherit">Balancing Work and Wellness:
                ...
                <div class="container max-w-xl">
                    <div class="navbar-container hstack border-bottom">
                        <div class="uc-navbar-center gap-2 lg:gap-3 flex-1">
                                                                ...
                                                                <div class="post-media panel overflow-hidden">
                                                                    <div
                                                                        ...
                                                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                            src="{{ asset('website/assets/images/common/img-fallback.png') }}"
                                                                            data-src="{{ asset('website/assets/images/demo-seven/posts/img-19.jpg') }}"
                                                            ...
                                                            <article
                                                                ...
                                                                <div class="post-media panel overflow-hidden">
                                                                    <div
                                                                        ...
                                                                        <img class="media-cover image uc-transition-scale-up uc-transition-opaque"
                                                                            src="{{ asset('website/assets/images/common/img-fallback.png') }}"
                                                                            data-src="{{ asset('website/assets/images/demo-seven/posts/img-20.jpg') }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div>
                                                                            <div class="post-date hstack gap-narrow">
                                                                                ...
                                                                                <!-- Wrapper start -->
                                                                                <div id="wrapper"
                                                                                    class="wrap overflow-hidden-x">

                                                                                    <!-- Section start -->
                                                                                    <div
                                                                                        class="section panel overflow-hidden swiper-parent border-top">
                                                                                        <div
                                                                                            class="section-outer panel py-2 lg:py-4 dark:text-white">
                                                                                            <div
                                                                                                class="container max-w-xl">
                                                                                                <div
                                                                                                    class="section-inner panel vstack gap-2">
                                                                                                    <div
                                                                                                        class="block-layout carousel-layout vstack gap-2 lg:gap-3 panel">
                                                                                                        <div
                                                                                                            class="block-content panel">
                                                                                                            <div class="swiper"
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <i
                                                                                                                    class="icon-1 unicon-chevron-left"></i>
                                                                                                            </div>
                                                                                                            <div
                                                                                                                ...
                                                                                                                <i
                                                                                                                    class="icon-1 unicon-chevron-right"></i>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                    ...
                                                                                    <div
                                                                                        class="section panel mb-4 lg:mb-6">
                                                                                        <div
                                                                                            class="section-outer panel">
                                                                                            <div
                                                                                                class="container max-w-xl">
                                                                                                <div
                                                                                                    class="section-inner panel vstack gap-4">
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                class="lg:col-9">
                                                                                                                <div
                                                                                                                    class="block-layout slider-layout swiper-parent uc-dark">
                                                                                                                    <div
                                                                                                                        class="block-content panel uc-visible-toggle">
                                                                                                                        <div class="swiper"
                                                                                                                                    ...
                                                                                                                                    <article
                                                                                                                                        ...
                                                                                                                                        <div class="post-header panel vstack justify-end items-start gap-1 p-2 sm:p-4 position-cover text-white"
                                                                                                                                            ...
                                                                                                                                            <h3
                                                                                                                                                class="post-title h5 lg:h4 xl:h3 m-0 max-w-600px text-white text-truncate-2">
                                                                                                                                                <a class="text-none text-white"
                                                                                                                                                    href="blog-details.html">Virtual
                                                                                                                                                    Reality
                                                                                                                                                    and
                                                                                                                                                    Mental
                                                                                                                                                    Health:
                                                                                                            ...
                                                                                                            <div
                                                                                                                class="lg:col-3">
                                                                                                                <div
                                                                                                                    class="panel cstack gap-2 h-100">
                                                                                                                    <div>
                                                                                                                        <div
                                                                                                                            class="widget ad-widget vstack gap-2">
                                                                                                                            <div
                                                                                                                                class="widget-title text-center">
                                                                                                                                <h5
                                                                                                                                    class="fs-7 ft-tertiary text-uppercase m-0">
                                                                                                                                    Sponsore
                                                                                                                                </h5>
                                                                                                                            </div>
                                                                                                                            <div
                                                                                                    ...
                                                                                                    <div class="row child-cols-12 lg:child-cols g-4 lg:g-6 col-match"
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    class="block-header panel pt-1 border-top">
                                                                                                                    <h2
                                                                                                                        ...
                                                                                                                        <a class="hstack d-inline-flex gap-0 text-none hover:text-primary duration-150"
                                                                                                                            ...
                                                                                                                            <span>Poltics</span>
                                                                                                                            <i
                                                                                                                                class="icon-1 fw-bold unicon-chevron-right"></i>
                                                                                                                        </a>
                                                                                                                    </h2>
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div class="panel row child-cols-12 md:child-cols g-2 lg:g-4 col-match sep-y"
                                                                                                                        data-uc-grid>
                                                                                                                        <div
                                                                                                                            class="col-12 md:col-6 order-0 md:order-1">
                                                                                                                            <div>
                                                                                                                                <article
                                                                                                                                    class="post type-post panel uc-transition-toggle vstack gap-2 lg:gap-3 h-100 overflow-hidden uc-dark">
                                                                                                                                    <div
                                                                                                                            ...
                                                                                                                            <div class="row child-cols-12 g-2 lg:g-4 sep-x"
                                                                                                                                ...
                                                                                                                                <div>
                                                                                                                                    <article
                                                                                                                                        ...
                                                                                                                                        <div class="row child-cols g-2 lg:g-3"
                                                                                                                                            data-uc-grid>
                                                                                                                                            <div>
                                                                                                                                                <div
                                                                                                                                                    class="post-header panel vstack justify-between gap-1">
                                                                                                                                            ...
                                                                                                                                            <div>
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <h3
                                                                                                                                                        class="post-title h6 m-0 text-truncate-2">
                                                                                                                                                        <a class="text-none hover:text-primary duration-150"
                                                                                                                                                            href="blog-details.html">Potential
                                                                                                                                                            of
                                                                                                                                                            Immersive
                                                                                                                                                            Technologies
                                                                                                                                                            help
                                                                                    ...
                                                                                    <!-- Section start -->
                                                                                    <div
                                                                                        class="section panel overflow-hidden swiper-parent">
                                                                                        <div
                                                                                            class="section-outer panel py-4 lg:py-6 dark:text-white">
                                                                                            <div
                                                                                                class="container max-w-xl">
                                                                                                <div
                                                                                                    class="section-inner panel vstack gap-2">
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <div>
                                                                                                                            <article
                                                                                                                                ...
                                                                                                                                <div
                                                                                                                                    class="post-header panel vstack gap-1">
                                                                                                                                    <h3
                                                                                                                                        class="post-title h6 m-0 text-truncate-2">
                                                                                                                                        <a class="text-none hover:text-primary duration-150"
                                                                                                                                            href="blog-details.html">Hidden
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div class="row child-cols-12 lg:child-cols g-4 lg:g-6 col-match"
                                                                                                        data-uc-grid>
                                                                                                        <div
                                                                                                            class="lg:col-8 order-0 lg:order-2">
                                                                                                            <div
                                                                                                                class="block-layout grid-layout vstack gap-2 lg:gap-3 panel overflow-hidden">
                                                                                                                <div
                                                                                                                    class="block-header panel pt-1 border-top">
                                                                                                                                            ...
                                                                                                                                            <div>
                                                                                                                                                <div
                                                                                                                                                    ...
                                                                                                                                                    <h3
                                                                                                                                                        class="post-title h6 m-0 text-truncate-2">
                                                                                                                                                        <a class="text-none hover:text-primary duration-150"
                                                                                                                                                            href="blog-details.html">Business
                                                                                                                                                            Agility
                                                                                                                                                            the
                                                                                                                                                            Digital
                                                                                                                                                            Age:
                                                                                                                                    ...
                                                                                                                                    <div>
                                                                                                                                        <div
                                                                                                                                            ...
                                                                                                                                            <h3
                                                                                                                                                class="post-title h6 m-0 text-truncate-2">
                                                                                                                                                <a class="text-none hover:text-primary duration-150"
                                                                                                                                                    href="blog-details.html">Balancing
                                                                                                                                                    Work
                                                                                                                                                    and
                                                                                                                                                    Wellness:
                                                                                                                                                    Tech
                                                                                    ...
                                                                                    <!-- Section start -->
                                                                                    <div id="live_now"
                                                                                        class="live_now section panel uc-dark swiper-parent">
                                                                                        <div
                                                                                            class="section-outer panel py-4 lg:py-6 bg-gray-900 text-white">
                                                                                            <div
                                                                                                class="container max-w-xl">
                                                                                                <div
                                                                                                    class="block-layout slider-thumbs-layout slider-thumbs panel vstack gap-2 lg:gap-3 panel overflow-hidden">
                                                                                                    <div
                                                                                                        class="block-header panel">
                                                                                                        <h2
                                                                                                            class="h6 ft-tertiary fw-bold ls-0 text-uppercase hstack gap-narrow m-0 text-black dark:text-white">
                                                                                                            <i class="icon-1 fw-bold unicon-dot-mark text-red"
                                                                                                                data-uc-animate="flash"></i>
                                                                                                            <span>Live
                                                                                                                now</span>
                                                                                                        </h2>
                                                                                                    </div>
                                                                                                    <div
                                                                                                        class="block-content">
                                                                                                        <div class="row child-cols-12 g-2"
                                                                                                            data-uc-grid>
                                                                                                            <div
                                                                                                                class="md:col-8 lg:col-9">
                                                                                                                <div
                                                                                                                    class="panel overflow-hidden rounded">
                                                                                                            ...
                                                                                                            <div
                                                                                                                class="md:col-4 lg:col-3">
                                                                                                                <div
                                                                                                                    class="panel md:vstack gap-1 h-100">
                            ...
                            watchOverflow: true">
                                                                                                                        <div
                                                                                                                            class="swiper-wrapper md:flex-1">
                                                                                                                            <div
                                                                                                                                class="swiper-slide overflow-hidden rounded min-h-64px lg:min-h-100px">
                                                                                                                                <div
                                                                                                                                    class="swiper-slide-progress position-cover z-0">
                                                                                                                                    <span></span>
                                                                                                                                </div>
                                                                                                                                <article
                                                                                                                                    ...
                                                                                                                                    <div
                                                                                                                                        class="row gx-1">
                                                                                                                                        <div
                                                                                                                                            class="col-auto post-media-wrap">
                                                                                                                                            <div
                                                                                    ...
                                                                                    <!-- Section start -->
                                                                                    <div id="latest_news"
                                                                                        class="latest-news section panel">
                                                                                        <div
                                                                                            class="section-outer panel py-4 lg:py-6">
                                                                                            <div
                                                                                                class="container max-w-xl">
                                                                                                <div
                                                                                                    class="section-inner">
                                                                                                    <div class="content-wrap row child-cols-12 g-4 lg:g-6"
                                                                                                        data-uc-grid>
                                                                                                        <div
                                                                                                            class="md:col-9">
                                                                                                            <div
                                                                                                                class="main-wrap panel vstack gap-3 lg:gap-6">
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        class="block-footer cstack lg:mt-2">
                                                                                                                        <a href="#"
                                                                                                                            ...
                                                                                                                            <span>Load
                                                                                                                                ...
                                                                                                                                posts</span>
                                                                                                                            <i
                                                                                                                                class="icon icon-1 unicon-chevron-right"></i>
                                                                                                                        </a>
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div class="sidebar-wrap panel vstack gap-2 pb-2"
                                                                                                                ...
                                                                                                                <div
                                                                                                                    class="widget popular-widget vstack gap-2 p-2 border">
                                                                                                                    <div
                                                                                                                        class="widget-title text-center">
                                                                                                                        <h5
                                                                                                                            class="fs-7 ft-tertiary text-uppercase m-0">
                                                                                                                ...
                                                                                                                <div
                                                                                                                    class="widget social-widget vstack gap-2 text-center p-2 border">
                                                                                                                    <div
                                                                                                                        class="widgt-title">
                                                                                                                        <h4
                                                                                                                            class="fs-7 ft-tertiary text-uppercase m-0">
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <ul
                                                                                                                            class="nav-x justify-center gap-1 mt-3">
                                                                                                                            <li>
                                                                                                                                <a href="#fb"
                                                                                ...
                                                                                <!-- Footer start -->
                                                                                <footer id="uc-footer"
                                                                                    class="uc-footer panel uc-dark">
                                                                                    <div
                                                                                        class="footer-outer py-4 lg:py-6 bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-opacity-50">
                                                                                        <div
                                                                                            class="container max-w-xl">
                                                                                            <div
                                                                                                class="footer-inner vstack gap-6 xl:gap-8">
                                                                                                <div
                                                                                                    class="uc-footer-bottom panel vstack gap-4 justify-center lg:fs-5">
                                                                                                    <nav
                                                                                                        class="footer-nav">
                                                                                                        <ul
                                                                                                            class="nav-x gap-2 lg:gap-4 justify-center text-center text-uppercase fw-medium">
                                                                                                            <li><a class="hover:text-gray-900 dark:hover:text-white duration-150"
                                                                                                                    href="blog-category.html">Politics</a>
                                                                                                            </li>
                                                                                                            <li><a class="hover:text-gray-900 dark:hover:text-white duration-150"
                                                                                                                    href="blog-category.html">Opinions</a>
                                                                                                            </li>
                                                                                                            <li><a class="hover:text-gray-900 dark:hover:text-white duration-150"
                                                                                                                    href="blog-category.html">World</a>
                                                                                                            </li>
                                                                                                            <li><a class="hover:text-gray-900 dark:hover:text-white duration-150"
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="footer-social hstack justify-center gap-2 lg:gap-3">
                                                                                                        <ul
                                                                                                            class="nav-x gap-2">
                                                                                                            <li>
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <a href="#"
                                                                                                                class="hstack gap-1 text-none fw-medium">
                                                                                                                <i
                                                                                                                    class="icon icon-1 unicon-earth-filled"></i>
                                                                                                                <span>English</span>
                                                                                                                <span
                                                                                                                    data-uc-drop-parent-icon=""></span>
                                                                                                            </a>
                                                                                                            <div class="p-2 bg-white dark:bg-gray-800 shadow-xs w-150px"
                                                                                                                ...
                                                                                                                <ul
                                                                                                                    class="nav-y gap-1 fw-medium items-end">
                                                                                                                    <li><a
                                                                                                                            href="#en">English</a>
                                                                                                                    </li>
                                                                                                                    <li><a
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="footer-copyright vstack sm:hstack justify-center items-center gap-1 lg:gap-2">
                                                                                                        <p>News5 ©
                                                                                                            <script>
                                                                                                                document.write(
